<footer>
 <div class="container">
    ...
    <div class="logo-footer">
     <img src="<?php bloginfo('template_url'); ?>/logos/foodservice.png" alt="" />
    </div>

    <div class="menu-footer">
		<ul>Máquinas y Equipos:
          <li><a href="<?php bloginfo('url'); ?>/maquinas-de-procesamiento/?_maquinas_de_procesamiento=embutidoras-al-vacio">Máquinas de Procesamiento</a></li>
          ...
          <li><a href="<?php bloginfo('url'); ?>/miscelaneos/?_miscelaneos=cuchillos-manuales">Miscelaneos</a></li>
