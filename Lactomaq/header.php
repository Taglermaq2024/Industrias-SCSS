...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/lactomaq.css?0.0.16" />
        ...
        <nav>
            <div class="navbar">
                ...
                <div class="logo"><a href="<?php bloginfo('url'); ?>"><img
                            src="<?php bloginfo('template_url'); ?>/images/logo-lactomaq.jpg"
                            alt="Taglermaq / Lactomaq"></a></div>
                <div class="nav-links">
                    <div class="sidebar-logo">
                        <span class="logo-name"><img src="<?php bloginfo('template_url'); ?>/images/logo-lactomaq.jpg"
                                alt="Taglermaq / Lactomaq"></span>
                        <i class='bx bx-x'></i>
                    </div>
                    <ul class="links">
                            ...
                            <ul class="htmlCss-sub-menu sub-menu">
                                <div class="wrapper-menu-principal">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/maquinas-envasadoras/?_maquinas_envasadoras=envasadoras-flow-pack">
                                                <img class="img_icon color1"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_envasadora.svg">
                                                Máquinas Envasadoras
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/maquinas-de-procesamiento/?_maquinas_de_procesamiento=masajeadores-tumbler">
                                                <img class="img_icon color2"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_cortadoras.svg">
                                                Máquinas de procesamiento
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/maquinas-cortadoras/?_maquinas_cortadoras=maquinas-cortadora-cubos-y-tiras">
                                                <img class="img_icon color3"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_filtros-sanitarios.svg">
                                                Máquinas cortadoras
                                            </a>
                                        </li>
                                    </div>
                                    ...
                                    <div class="content-sub-menu">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/filtros-sanitarios/?_filtros_sanitarios=desinfectante-de-manos">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/sistemas-de-inspeccion/?_sistemas_de_inspeccion=rayos-x">
                                                <img class="img_icon color5"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_inspeccion.svg">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/higiene-e-inocuidad/?_higiene_e_inocuidad=bio-desinfeccion">
                                                <img class="img_icon color6"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_higiene-inocuidad.svg">
                                                Higiene e Inocuidad
                                            </a>
                                        </li>
                                    </div>
                                       ...
                                       <li>
                                            <a href="<?php bloginfo('url'); ?>/lavadoras-industriales">
                                                <img class="img_icon color7"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_lavadoras.svg">
                                                Lavadoras Industriales
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/miscelaneos/?_miscelaneos=guantes-de-seguridad">
                                                <img class="img_icon color8"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_desposte.svg">
                                                Miscelaneos
                                            </a>
                                        </li>
