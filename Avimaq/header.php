...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/avimaq.css?0.0.27" />
        ...
        <nav>
            <div class="navbar">
                ...
                <div class="logo"><a href="<?php bloginfo('url'); ?>"><img
                            src="<?php bloginfo('template_url'); ?>/images/logo-avimaq.jpg"
                            alt="Taglermaq / avimaq"></a></div>
                <div class="nav-links">
                    <div class="sidebar-logo">
                        <span class="logo-name"><img src="<?php bloginfo('template_url'); ?>/images/logo-avimaq.jpg"
                                alt="Taglermaq / avimaq"></span>
                        <i class='bx bx-x'></i>
                    </div>
                    <ul class="links">
