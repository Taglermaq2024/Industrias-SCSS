<footer>
 <div class="container">
    ...
    <div class="logo-footer">
     <img src="<?php bloginfo('template_url'); ?>/logos/veganveggie.png" alt="Vegmaq" />
    </div>
    ...
    <div class="menu-footer">
        <ul>Máquinas y Equipos
          ...
          <li><a href="<?php bloginfo('url'); ?>/porcionado-y-formado/">Porcionado y Formado</a></li>
          ...
          <li><a href="<?php bloginfo('url'); ?>/dosificadores-multicabezales">Dosificadores Multicabezales</a></li>
          <li><a href="<?php bloginfo('url'); ?>/elaboracion-de-masas">Elaboración de Masas</a></li>
          <li><a href="<?php bloginfo('url'); ?>/fabricadoras-de-hielo">Fabricadoras de hielo</a></li>
        </ul>

        <ul>Aplicaciones
          <li><a href="<?php bloginfo('url'); ?>/hamburguesas/?_hamburguesas=porcionado-y-formado">Hamburguesas</a></li>
          <li><a href="<?php bloginfo('url'); ?>/nuggets/?_nuggets=porcionado-y-formado">Nuggets</a></li>
          <li><a href="<?php bloginfo('url'); ?>/formados/?_formados=porcionado-y-formado">Formados</a></li>
        </ul>
