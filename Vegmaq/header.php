...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/vegmaq.css?0.0.16" />
        ...
        <nav>
            <div class="navbar">
                ...
                <div class="logo"><a href="<?php bloginfo('url'); ?>"><img
                            src="<?php bloginfo('template_url'); ?>/images/logo-vegmaq.jpg"
                            ...
                            <ul class="htmlCss-sub-menu sub-menu">
                                <div class="wrapper-menu-principal">
                                    ...
                                    <div class="content-sub-menu">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/porcionado-y-formado">
                                                <img class="img_icon color8"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_marmitas.svg">
                                    ...
                                    <div class="content-sub-menu">
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/procesadora-de-vegetales/?_procesadora_de_vegetales=calibradoras">
                                                <img class="img_icon color9"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_miscelaneos.svg">
                                        ...
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/dosificadores-multicabezales">
                                                <img class="img_icon color1"
                                                    src="https://taglertesting.cl/taglermaq2024/vegmaq/wp-content/uploads/sites/2/2024/05/ico_envasadora.svg">
                                                Dosificadores Multicabezales
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php bloginfo('url'); ?>/elaboracion-de-masas">
