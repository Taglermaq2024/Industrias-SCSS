<footer>
 <div class="container">
    ...
    <div class="logo-footer">
     <img src="<?php bloginfo('template_url'); ?>/logos/aquamaq.png" alt="Aquamaq" />
    </div>
    ...
    <div class="menu-footer">
        <ul>Máquinas y Equipos
          ...
          <li><a href="<?php bloginfo('url'); ?>/maquinas-de-porcionado-y-laminado/?_maquinas_de_porcionado_y_laminado=cutter">Máquinas de Porcionado y laminado</a></li>
          <li><a href="<?php bloginfo('url'); ?>/equipos-para-prolijado-y-fileteo/?_equipos_para_prolijado_y_fileteo=cuchillos-circulares-bettcher">Equipos para Prolijado y fileteo</a></li>
        ...
        <ul>Aplicaciones
          ...
          <li><a href="<?php bloginfo('url'); ?>/hamburguesas-y-palitos/?_hamburguesas_y_palitos=envasadoras-termoformadoras">Hamburguesas y Palitos</a></li>
          <li><a href="<?php bloginfo('url'); ?>/salchichas-conpro/?_salchichas_conpro=envasadoras-termoformadoras">Salchicha ConPro</a></li>
          <li><a href="<?php bloginfo('url'); ?>/salchichas/?_salchichas=envasadoras-termoformadoras">Salchichas</a></li>
          <li><a href="<?php bloginfo('url'); ?>/surimi-caviar-y-sushi/?_surimi_caviar_y_sushi=envasadoras-termoselladoras-top-seal">Surimi, Caviar y Sushi</a></li>
          <li><a href="<?php bloginfo('url'); ?>/pate/?_pate=envasadoras-vertical">Paté</a></li>
          <li><a href="<?php bloginfo('url'); ?>/ensaladas/?_ensaladas=envasadoras-termoformadoras">Ensaladas</a></li>
          <li><a href="<?php bloginfo('url'); ?>/carpaccio/?_carpaccio=envasadoras-termoformadoras">Carpaccio</a></li>
          <li><a href="<?php bloginfo('url'); ?>/coating/?_coating=envasadoras-vertical">Coating</a></li>
        </ul>
