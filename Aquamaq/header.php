...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/aquamaq.css?0.0.20" />
        ...
        <nav>
            <div class="navbar">
                ...
                <div class="logo"><a href="<?php bloginfo('url'); ?>"><img
                            src="<?php bloginfo('template_url'); ?>/images/logo-aquamaq.jpg"
                            alt="Taglermaq / Aquamaq"></a></div>
                <div class="nav-links">
                    <div class="sidebar-logo">
                        <span class="logo-name"><img src="<?php bloginfo('template_url'); ?>/images/logo-aquamaq.jpg"
                                alt="Taglermaq / Aquamaq"></span>
                        <i class='bx bx-x'></i>
                    </div>
                    <ul class="links">
                            ...
                            <ul class="htmlCss-sub-menu sub-menu">
                                <div class="wrapper-menu-principal">
                                    <div class="content-sub-menu">
                                        ...
                                        <li><a
                                                href="<?php bloginfo('url'); ?>/maquinas-de-porcionado-y-laminado/?_maquinas_de_porcionado_y_laminado=cutter">
                                                ...
                                                Máquinas de Porcionado y laminado
                                            </a>
                                        </li>
                                    </div>
                                    ...
                                    <div class="content-sub-menu">
                                        <li>
                                            <a
                                                href="<?php bloginfo('url'); ?>/equipos-para-prolijado-y-fileteo?_equipos_para_prolijado_y_fileteo=cuchillos-circulares-bettcher">
                                                ...
                                                Equipos para prolijado y fileteo
                                            </a>
                                        </li>
                                        <li>
                                            <a
