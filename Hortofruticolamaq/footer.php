<footer>
 <div class="container">
    ...
    <div class="logo-footer">
     <img src="<?php bloginfo('template_url'); ?>/logos/hortofruticola.png" alt="Hortofruticola" />
    </div>
    ...
    <ul>Máquinas y Equipos
        ...
        <li><a href="<?php bloginfo('url'); ?>/higiene-e-inocuidad/?_higiene_e_inocuidad=bio-desinfeccion">Higiene e Inocuidad</a></li>
        </ul>
        <ul>Hortofrutícola
